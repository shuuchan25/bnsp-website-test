                    ...
                    <form action="/admin/infos" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="date" name="date" id="date" class="@error('date') is-invalid @enderror" value="{{ old('date') }}" required placeholder="Masukkan nomor telepon">
                                    @error('date')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="text" name="source" id="source" class="@error('source') is-invalid @enderror" value="{{ old('source') }}" required placeholder="Source">
                                    @error('source')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="text" name="video" id="video" class="@error('video') is-invalid @enderror" value="{{ old('video') }}" placeholder="Video">
                                    @error('video')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                <label for="image">Main Image (Max. 1 file & 5MB)</label>
                        ...
                        <div class="modal-footer w-100">
                            <button type="button" class="btn cancel-btn mb-0" onclick="location.href='/admin/infos'">Cancel</button>
