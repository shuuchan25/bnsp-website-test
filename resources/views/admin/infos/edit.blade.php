    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-3 pb-2">
                <div class="">
                    <p class="">Hi Admin,</p>
                    <h3 class="">Edit News</h3>
                </div>
            </div>
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/infos/{{ $info->slug }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name"
                                        class="@error('name') is-invalid @enderror" value="{{ old('name', $info->name) }}"
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug"
                                        class="@error('slug') is-invalid @enderror" value="{{ old('slug', $info->slug) }}"
                                ...
                                <div class="select-box">
                                    <select name="category_id">
                                        @foreach ($categories as $category)
                                            @if (old('category_id', $info->category_id) == $category->id)
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="date" name="date" id="date"
                                        class="@error('date') is-invalid @enderror" value="{{ old('date', $info->date) }}"
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="text" name="source" id="source"
                                        class="@error('source') is-invalid @enderror"
                                        value="{{ old('source', $info->source) }}" required
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="video" id="video"
                                        ...
                                        value="{{ old('video', $info->video) }}" placeholder="">
                                    @error('video')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-100 pt-3">
                            <label for="">Main Image (Max. 1 file & 5MB)</label>
                            <div class="w-100">
                                <input type="file" name="image" id="image"
                                    class="@error('image') is-invalid @enderror"
                                    value="{{ old('image', $info->image) }}" onchange="previewImage()">
                                @error('image')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="w-100 pt-3">
                            <div class="w-100 pt-3">
                                ...
                                <input type="hidden" name="content" id="content"
                                    value="{{ old('content', $info->content) }}">
                                @error('content')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="modal-footer w-100">
                            <button type="button" class="btn cancel-btn mb-0"
                                onclick="location.href='/admin/infos'">Cancel</button>
                ...
                <div class="w-100 pt-3 mt-3 border-top">
                    ...
                    <div class="modal-body add-form pb-3">
                        <form action="/admin/info-images/{{ $info->id }}" method="POST" class=""
                            ...
                            <div class="image-list pt-3 w-100 d-flex gap-2">
                                ...
                                @foreach ($other_images as $other_image)
                                    <div class="image-item">
                                        ...
                                        <form action="{{ route('admin.infoimages.destroy', $other_image->id) }}"
                                            method="POST"
        ...
        <script>
            ...
            name.addEventListener('change', function() {
                fetch('/admin/infos/checkSlug?name=' + name.value)
