    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/infos/create'">Create News</button>
                </div>
            </div>
            <div class="content-wrapper">
                ...
                @endif
                <form action="/admin/infos" method="GET" id="search-form" class="w-100">
                    @csrf
                            ...
                            <tr class="table-item">
                                <td class="">
                                    <div class="first-column">
                                        <p class="first-p">{{ $info->name }}</p>
                                    </div>
                                </td>
                                <td class="">{{ optional($info->category)->name }}</td>
                                <td class=""><img src="{{ Storage::url($info->image) }}" alt="" class="image-card"></td>
                                <td class="">
                                    <div class="action-buttons">

                                        <button class="" onclick="location.href='/admin/infos/{{ $info->slug }}'">
                                        ...
                                        <button class="" onclick="location.href='/admin/infos/{{ $info->slug }}/edit'">
                                        ...
                                        <form action="/admin/infos/{{ $info->slug }}" method="POST"
...
<script>
    $(document).ready(function () {
        $('#search-input').on('input', function () {
            ...
            if (query.length >= 2) {
                $.ajax({
                    url: '/admin/infos', // Gunakan rute yang sama dengan halaman index
                    method: 'GET',
                    data: { search: query },
