    ...
    <div id="sidebarMenu" class="sidebar-menu">
        <div class="w-100">
            ...
            <div class="menu-buttons">
                ...
                <div class="">
                    <button class="justify-content-between {{ Request::is('admin/about') || Request::is('admin/socmed') || Request::is('admin/hero-gallery') ? 'active-menu' : '' }}" type="button" data-bs-toggle="collapse"
                ...
                <div class="">
                    <button class="justify-content-between {{ Request::is('admin/articles*') || Request::is('admin/reviews*') || Request::is('admin/events*') || Request::is('admin/infos*') || Request::is('admin/schedules*') || Request::is('admin/arts*') ? 'active-menu' : '' }}" type="button" data-bs-toggle="collapse"
