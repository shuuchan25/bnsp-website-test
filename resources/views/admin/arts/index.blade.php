    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/arts/create'">Add Art</button>
                </div>
            </div>
            ...
            <div class="content-wrapper">
                ...
                <form action="/admin/arts" method="GET" id="search-form" class="w-100">
                @csrf
                    ...
                    @if ($arts->count() > 0)
                        <table class="" id="table-container">
                            <tr class="bg-[#F6F6F6] text-sm ">
                                <th class="col-one">Name</th>
                                <th class="col-three">Illsutrator</th>
                                ...
                                <tr class="table-item">
                                    <td class="">
                                        <div class="first-column">
                                            <p class="first-p">{{ $art->name }}</p>
                                        </div>
                                        </td>
                                        <td class="">{{ optional($art->category)->name }}</td>

                                        <td class=""><img src="{{ Storage::url($art->image) }}" alt="" style="width: 200px; border-radius: 8px;"></td>
                                        <td class="">
                                            <div class="action-buttons">
                                                <button class=""
                                                    onclick="location.href='/admin/arts/{{ $art->slug }}'">
                                                ...
                                                <button class=""
                                                    onclick="location.href='/admin/arts/{{ $art->slug }}/edit'">
                                                ...
                                                <form action="/admin/arts/{{ $art->slug }}" method="POST"
        ...
        <div class="pagination d-flex justify-content-center pt-4">
            {{ $arts->links('admin.partials.custom_pagination') }}
        </div>
    </section>
@endsection
...
<script>
    $(document).ready(function () {
        $('#search-input').on('input', function () {
            ...
            if (query.length >= 2) {
                $.ajax({
                    url: '/admin/arts', // Gunakan rute yang sama dengan halaman index
                    method: 'GET',
                    data: { search: query },
