    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/products/create'">Create
                        Product</button>
                </div>
            </div>
            <div class="content-wrapper">
                ...
                @endif
                <form action="/admin/products" method="GET" id="search-form" class="w-100">
                    @csrf
                                ...
                                <tr class="table-item">
                                    <td class="">
                                        <div class="first-column">
                                            <p class="first-p">{{ $product->name }}</p>
                                        </div>
                                    </td>
                                    <td class=""><img src="{{ Storage::url($product->image) }}" alt=""
                                            class="image-card"></td>
                                    <td class="">
                                        <div class="action-buttons">

                                            <button class=""
                                                onclick="location.href='/admin/products/{{ $product->slug }}'">
                                            ...
                                            <button class=""
                                                onclick="location.href='/admin/products/{{ $product->slug }}/edit'">
    ...
    <script>
        $(document).ready(function() {
            $('#search-input').on('input', function() {
                ...
                if (query.length >= 2) {
                    $.ajax({
                        url: '/admin/products', // Gunakan rute yang sama dengan halaman index
                        method: 'GET',
                        data: {
                            search: query
                        },
