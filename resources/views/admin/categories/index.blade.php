    ...
    <section class="page-section">
        ...
        <div class="page-content d-flex flex-column align-items-center">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2 w-100">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/categories/create'">Add Category</button>
                </div>
            </div>
                ...
                <div class="overflow-x-auto w-100">
                    ...
                    <table id="table-container" class="">
                        <tr class="bg-[#F6F6F6] text-sm ">
                            <th class="col-one">Category</th>
                            <th class="col-one">Color</th>
                            ...
                            <tr class="table-item">
                                <td class="">
                                    <div class="first-column">
                                            <p class="first-p">{{ $category->name }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="">
                                    <div class="">
                                        <div class="tag-color " style="background: {{ $category->color }}; width: 50px; height: 50px; border-radius: 50px;">
                                        </div>
                                    </div>
                                </td>
                                <td class="">
                                    <div class="action-buttons">
                                        <button class="" onclick="location.href='/admin/categories/{{ $category->slug }}/edit'">
                                        ...
                                        <form action="/admin/categories/{{ $category->slug }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this data?')">
                                            @csrf
                                            @method('delete')
