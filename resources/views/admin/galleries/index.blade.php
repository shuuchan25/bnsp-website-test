    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/galleries/create'">Add
                        Image</button>
                </div>
            </div>
            ...
            <div class="content-wrapper">
                ...
                <form action="/admin/galleries" method="GET" id="search-form" class="w-100">
                    @csrf
                                ...
                                <tr class="table-item">
                                    <td class="">
                                        <div class="first-column">
                                            <p class="first-p">{{ $gallery->name }}</p>
                                        </div>
                                    </td>
                                    ...
                                    <td class="">
                                        <div class="action-buttons">
                                            {{-- <button class=""
                                                onclick="location.href='/admin/galleries/{{ $gallery->slug }}'">
                                            ...
                                            <button class=""
                                                onclick="location.href='/admin/galleries/{{ $gallery->slug }}/edit'">
                                            ...
                                            <form action="/admin/galleries/{{ $gallery->slug }}" method="POST"
            ...
            <div class="pagination d-flex justify-content-center pt-4">
                {{ $galleries->links('admin.partials.custom_pagination') }}
            </div>
    </section>
@endsection
    ...
    <script>
        $(document).ready(function() {
            $('#search-input').on('input', function() {
                ...
                if (query.length >= 2) {
                    $.ajax({
                        url: '/admin/galleries', // Gunakan rute yang sama dengan halaman index
                        method: 'GET',
                        data: {
                            search: query
                        },
                        success: function(data) {
                            $('#table-container').html(
                                data
                            ); // Menampilkan hasil penSearchan di div dengan id "table-container"
                        }
                    });
                } else {
