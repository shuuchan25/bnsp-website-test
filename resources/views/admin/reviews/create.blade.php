                    ...
                    <form action="/admin/reviews" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="text" name="author" id="author" class="@error('author') is-invalid @enderror" value="{{ old('author') }}" required placeholder="Author name">
                                    @error('author')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="text" name="kanji" id="kanji" class="@error('kanji') is-invalid @enderror" value="{{ old('kanji') }}" required placeholder="Alternative name">
                                    @error('kanji')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-100 pt-3">
                            ...
                            <input type="hidden" name="review" id="review" value="{{ old('review') }}">
                            @error('review')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="modal-footer w-100">
                            <button type="button" class="btn cancel-btn mb-0" onclick="location.href='/admin/reviews'">Cancel</button>
