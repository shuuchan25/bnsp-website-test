    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/reviews/create'">Add Review</button>
                </div>
            </div>
                            ...
                            <tr class="table-item">
                                <td class="">
                                    <div class="first-column">
                                        <p class="first-p">{{ $review->name }}</p>
                                    </div>
                                </td>
                                <td class="">{{ optional($review->category)->name }}</td>
                                <td class=""><img src="{{ Storage::url($review->image) }}" alt="" class="image-card"></td>
                                <td class="">
                                    <div class="action-buttons">

                                        <button class="" onclick="location.href='/admin/reviews/{{ $review->slug }}'">
                                        ...
                                        <button class="" onclick="location.href='/admin/reviews/{{ $review->slug }}/edit'">
                                        ...
                                        <form action="/admin/reviews/{{ $review->slug }}" method="POST"
...
<script>
    $(document).ready(function () {
        $('#search-input').on('input', function () {
            ...
            if (query.length >= 2) {
                $.ajax({
                    url: '/admin/reviews', // Gunakan rute yang sama dengan halaman index
                    method: 'GET',
                    data: { search: query },
