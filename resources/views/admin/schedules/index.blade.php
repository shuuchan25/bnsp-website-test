    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/schedules/create'">Create
                        Schedule</button>
                </div>
            </div>
                        ...
                        <table id="table-container" class="">
                            ...
                            @foreach ($schedules as $schedule)
                                <tr class="table-item">
                                    ...
                                    <td class=""><img src="{{ Storage::url($schedule->image) }}" alt=""
                                            class="image-card"></td>
                                    <td class="">
                                        <div class="action-buttons">

                                            <button class=""
                                                onclick="location.href='/admin/schedules/{{ $schedule->slug }}'">
                                            ...
                                            <button class=""
                                                onclick="location.href='/admin/schedules/{{ $schedule->slug }}/edit'">
                ...
                if (query.length >= 2) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            data); // Menampilkan hasil penSearchan di div dengan id "table-container"
                        }
                    });
                } else {
