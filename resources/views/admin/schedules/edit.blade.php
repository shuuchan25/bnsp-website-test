    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-3 pb-2">
                <div class="">
                    <p class="">Hi Admin,</p>
                    <h3 class="">Edit Schedule</h3>
                </div>
            </div>
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/schedules/{{ $schedule->slug }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                                ...
                                <div class="select-box">
                                    <select name="category_id">
                                        @foreach ($categories as $category)
                                            @if (old('category_id', $schedule->category_id) == $category->id)
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="text" name="author" id="author"
                                        ...
                                        value="{{ old('author', $schedule->author) }}" required
                ...
                {{-- <div class="w-100 pt-3 mt-3 border-top">
                    ...
                    <div class="modal-body add-form pb-3">
                        <form action="/admin/schedule-images/{{ $schedule->id }}" method="POST" class=""
