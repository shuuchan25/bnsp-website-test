        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="modal-body add-form pb-3">
                    <form action="/admin/hero-gallery" method="POST" class="" enctype="multipart/form-data">
                        @csrf
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between">
                            ...
                            <div class="select-box w-100 pt-3 pt-md-0">
                                <label for="kategori">Image Orientation</label>
                                <div class="select-box">
                                    <select name="image_orientation_id">
                                        @foreach ($imageOrientations as $imageOrientation)
                                            <option value="{{ $imageOrientation->id }}">{{ $imageOrientation->name }}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="">
                        ...
                        @if (isset($heroimages) && (is_array($heroimages) || is_object($heroimages)) && count($heroimages) > 0)
                            <div class="d-md-flex justify-content-between w-100">
                                    ...
                                    @foreach ($heroimages as $heroimage)
                                        @if ($heroimage->imageOrientation->name === 'portrait')
                                            <div class="image-item">
                                                ...
                                                <form action="{{ route('admin.hero-gallery.destroy', $heroimage->id) }}"
                                                    method="POST"
                                ...
                                <div class="image-list pt-3 w-100 d-flex gap-2">
                                    @foreach ($heroimages as $heroimage)
                                        @if ($heroimage->imageOrientation->name === 'landscape')
                                            <div class="image-item">
                                                <div class="image-card">
                                                    <img src="{{ asset('storage/' . $heroimage->image) }}" alt="">
                                                </div>
