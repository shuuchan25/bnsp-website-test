    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/reviews/create'">Add
                        Review</button>
                </div>
            </div>
                        ...
                        <table id="table-container" class="">
                            ...
                            @foreach ($reviews as $review)
                                <tr class="table-item">
                                    ...
                                    <td class=""><img src="{{ Storage::url($review->image) }}" alt=""
                                            class="image-card"></td>
                                    <td class="">
                                        <div class="action-buttons">

                                            <button class=""
                                                onclick="location.href='/admin/reviews/{{ $review->slug }}'">
                                            ...
                                            <button class=""
                                                onclick="location.href='/admin/reviews/{{ $review->slug }}/edit'">
