...
class ArticleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/articles')->with('success', 'The new data has been successfully created..');
    }
    ...
    public function update(Request $request, Article $article)
    {
        ...
        return redirect('/admin/articles')->with('success', 'The data has been successfully updated..');
    }
    ...
    public function destroy(Article $article)
    {
        ...
        return redirect('/admin/articles')->with('success', 'The data has been successfully deleted..');
    }
